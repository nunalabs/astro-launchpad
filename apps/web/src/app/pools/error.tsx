...
export default function PoolsError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error('Pools page error', error, { page: 'pools' });
  }, [error]);
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-6">
          Unable to load liquidity pools. Please try again.
        </p>
