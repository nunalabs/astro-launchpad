...
import { TrendingUp, Rocket, Shield, FileCode, ExternalLink } from 'lucide-react';
...
export function HomeClient({ initialTokenCount }: HomeClientProps) {
  // Note: useWallet hook available for future wallet-dependent features
  useWallet();
